...
MENU_ITEM_LINK = '/corsi/lista/'     # Il link che voglio trovare per capire che quel menù è presente.
...
class FormGeneralTests(MyAccountTestCase):
    ...
    def setUp(self):
        ...
        super().setUp()
        self.myuser.profile.permessi = {SiwPermessi.MENU_CORSI, SiwPermessi.MENU_CORSI_LISTA}
