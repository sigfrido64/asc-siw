...
"""
TODO
1) FATTO ! : Devo definire un modello che contenga i recapiti e che faccia riferimento ad una anagrafica di una persona.

2) FATTO ! Voglio una pagine che richiamo con :

\collaboratori\anagrafica\lista\
Nella quale avrò una tabella con elenco dei collaboratori per Cognome, Nome e link al dettaglio.

3) FATTO ! Voglio una pagina di dettaglio del collaboratore con :
...
Persona : Scelta da menù a discesa che si popola man mano che scrivo
