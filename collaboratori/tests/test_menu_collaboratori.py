...
MENU_ITEM_LINK = '/collaboratori/anagrafica/lista/'    # Il link che voglio trovare per capire che quel menù è presente.
...
class FormGeneralTests(MyAccountTestCase):
    ...
    def setUp(self):
        ...
        super().setUp()
        self.myuser.profile.permessi = {SiwPermessi.MENU_COLLABORATORI, SiwPermessi.MENU_COLLABORATORI_LISTA}
