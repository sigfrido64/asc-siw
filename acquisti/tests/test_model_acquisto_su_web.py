...
class ModelloRipartizioniTests(TestCase):
    ...
    def carica_ripartizione_indetraibile(self):
        self.ripartizione1 = RipartizioneSpesaPerCDC(acquisto=self.acquisto_web, cdc=self.cdc1,
                                                     percentuale_di_competenza=50)
        self.ripartizione1.save()

    def carica_ripartizione_detraibile(self):
        self.ripartizione2 = RipartizioneSpesaPerCDC(acquisto=self.acquisto_web, cdc=self.cdc2,
                                                     percentuale_di_competenza=50)
