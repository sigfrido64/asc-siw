...
from .views import allinea_persone_view, allinea_aziende_view, allinea_contatti_aziende_view, allinea_prova
...
urlpatterns = [
    ...
    path('aggiorna/tutto/', allinea_prova, name="allinea-tutto"),
]
